...
- **THEN** the system stores the selected feature indices in `Prediccion.importanciaVariables` (JSON)
...
- **THEN** the system stores the best hyperparameters in `Prediccion.metadataTecnica` (JSON)
